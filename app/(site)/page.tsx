    ...
    <main className="min-h-screen bg-[#050505] text-white overflow-x-hidden selection:bg-neon-green selection:text-black">
      ...
      <section className="py-24 px-4 bg-[#050505]">
        <div className="container mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Card 1: SOLUTIONS */}
          <div className="group p-8 rounded-none border border-neon-green/30 bg-deep-emerald/5 hover:border-neon-green/50 hover:bg-deep-emerald/10 transition-all duration-500">
            <Code className="text-neon-green mb-6 w-10 h-10" />
            <span className="block font-mono text-xs text-neon-green mb-2">B2B / HIGH-PERFORMANCE</span>
            ...
            <Link href="/marrocsolutions" className="block w-full py-3 text-center bg-neon-green hover:bg-white hover:text-black text-black font-bold uppercase tracking-widest text-xs transition-colors">
              Agendar Auditoria
            </Link>
          </div>
